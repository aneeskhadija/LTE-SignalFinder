...
* For post processing, the application saves comma-separated variables (CSV) files with data points as a function of time.  The file path may vary per device, but a typical path is "Android/data/pvtydroid.oism.asd.ltecoveragetool/files/Sep_18_2018_1:30:58_PM.csv".
...
## TECHNICAL SUPPORT
For more information concerning the LTE Coverage Tool application and SDK, please contact pscr@nist.com.
