...
class LATESegnalFinderSpeedTest_ReadData implements Serializable {
    ...
    LATESegnalFinderSpeedTest_ReadData() {
    ...
    LATESegnalFinderSpeedTest_ReadData(LATESegnalFinderSpeedTest_ReadData speedTestReadData) {
        this.timestamp = new Date();
        this.rsrp = speedTestReadData.rsrp;
        this.rsrq = speedTestReadData.rsrq;
        this.pci = speedTestReadData.pci;
    }
